...
export function basemapStyle(
	...
	return {
		...
		sources: {
			protomaps: {
				type: 'vector',
				url: tileJson || `https://api.protomaps.com/tiles/v4.json?key=${protomapsApiKey}`,
...
export function addTerrain(map: maplibregl.Map, maplibregl: unknown, tiles?: string) {
...
export function removeTerrain(map: maplibregl.Map) {
