...
For the map overview and timeline thumbnails, image sprites are used which can be found in the `static/sprites` directory. They have been generated by the scripts in [this repository](https://github.com/allmaps/sprite-test).
...
```env
PUBLIC_GEOCODE_EARTH_API_KEY=
PUBLIC_PROTOMAPS_KEY=
```
...
The console may throw errors related to the missing Geocoder Earth and Protomaps keys.
